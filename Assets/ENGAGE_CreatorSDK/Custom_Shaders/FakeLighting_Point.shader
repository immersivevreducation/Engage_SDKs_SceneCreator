...
Shader "Unlit/FakeLighting_Point"
{
     Properties {
    ...
    SubShader
    {
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 Direction;
                    Direction.x= _LightPosition.x;
                    Direction.y= _LightPosition.y;
                    Direction.z= _LightPosition.z;
                //Direction = mul(Direction ,_LightSoftness);
                fixed3 lightDiffrence = i.worldPos - Direction;
