...
////////////////////////////////////////////////////////UI Variables///////////////////////////////////////////////////////
        ...
        public bool fullSyncToggle {get; set;}
    ...
    /////////////////////////////////////// -----UI-----///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        void MainUI()
        {
            ...
            string[] selStrings = new string[] {"Build Bundles", "Prefab Tools", "Organising Tools","Creation Tools","Settings"};
        ...
        {           
            ...
            userSettings.enableGuiOnBuilds = EditorGUILayout.Toggle("Enable Child Projects GUI", userSettings.enableGuiOnBuilds);
            ...
            if (GUILayout.Button("AssetBundle From Selection"))
            {
                ...
                else
                {
                    ...
                    buildSettings.fullSync = userSettings.fullSyncProjectOnBuild;
        ...
        {          
            ...
            EditorGUILayout.LabelField("Full Sync Build Mode takes alot longer to perform it's initial build");
            EditorGUILayout.LabelField("(likely Several hours) but it is more reliable ");
            EditorGUILayout.LabelField("Use this if you are not in a hurry and will be building often from this project");
            userSettings.fullSyncProjectOnBuild = EditorGUILayout.Toggle( "Full Sync Build Mode", userSettings.fullSyncProjectOnBuild); 
