...
public class PoseTriggerEditor : Editor
{
    ...
    private void DrawConstraintEditor()
    {
        GUILayout.Space(20);
        ...
        DrawConstraint(PoseBodyPart.PELVIS);
        //DrawOverride(PoseBodyPart.HEAD);
        //DrawOverride(PoseBodyPart.CHEST);

        DrawConstraint(PoseBodyPart.RIGHT_HAND);
        DrawConstraint(PoseBodyPart.LEFT_HAND);
        DrawConstraint(PoseBodyPart.RIGHT_ELBOW);
        DrawConstraint(PoseBodyPart.LEFT_ELBOW);

        DrawConstraint(PoseBodyPart.RIGHT_FOOT);
        DrawConstraint(PoseBodyPart.LEFT_FOOT);
        DrawConstraint(PoseBodyPart.RIGHT_KNEE);
        DrawConstraint(PoseBodyPart.LEFT_KNEE);
    ...
    private void DrawConstraint(PoseBodyPart bodyPart)
    {
